...
feature1 = st.sidebar.number_input("Age", min_value=0.0, key="age")
feature2 = st.sidebar.number_input("BMI", min_value=0.0, key="bmi")
feature3 = st.sidebar.number_input("Blood_Pressure", min_value=0.0, key="bp")
feature4 = st.sidebar.number_input("Cholesterol", min_value=0.0, key="chol")
feature5 = st.sidebar.number_input("Glucose_Level", min_value=0.0, key="glucose")
feature6 = st.sidebar.number_input("Heart_Rate", min_value=0.0, key="hr")
feature7 = st.sidebar.number_input("Sleep_Hours", min_value=0.0, key="sleep")
feature8 = st.sidebar.number_input("Exercise_Hours", min_value=0.0, key="exercise")
feature9 = st.sidebar.number_input("Water_Intake", min_value=0.0, key="water")
feature10 = st.sidebar.number_input("Stress_Level", min_value=0.0, key="stress")
feature11 = st.sidebar.number_input("Smoking", min_value=0.0, key="smoking")
feature12 = st.sidebar.number_input("Alcohol", min_value=0.0, key="alcohol")
feature13 = st.sidebar.number_input("Diet", min_value=0.0, key="diet")
feature14 = st.sidebar.number_input("MentalHealth", min_value=0.0, key="mental")
feature15 = st.sidebar.number_input("PhysicalActivity", min_value=0.0, key="physical")
feature16 = st.sidebar.number_input("MedicalHistory", min_value=0.0, key="medical")
feature17 = st.sidebar.number_input("Allergies", min_value=0.0, key="allergies")
feature18 = st.sidebar.number_input("Diet_Type__Vegan", min_value=0.0, key="vegan")
feature19 = st.sidebar.number_input("Diet_Type__Vegetarian", min_value=0.0, key="veg")
feature20 = st.sidebar.number_input("Blood_Group_AB", min_value=0.0, key="ab")
feature21 = st.sidebar.number_input("Blood_Group_B", min_value=0.0, key="b")
feature22 = st.sidebar.number_input("Blood_Group_O", min_value=0.0, key="o")
